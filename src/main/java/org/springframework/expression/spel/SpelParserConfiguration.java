...
/**
 * Configuration object for the SpEL org.springframework.org.springframework.expression parser.
 *
 * @author Juergen Hoeller
 * @author Phillip Webb
 * @author Andy Clement
 * @since 3.0
 * @see org.springframework.expression.spel.standard.SpelExpressionParser#SpelExpressionParser(org.springframework.expression.spel.SpelParserConfiguration)
 */
public class SpelParserConfiguration {

	/** System property to configure the default compiler mode for SpEL org.springframework.org.springframework.expression parsers: {@value}. */
	public static final String SPRING_EXPRESSION_COMPILER_MODE_PROPERTY_NAME = "spring.org.springframework.org.springframework.expression.compiler.mode";
	 ...
	 * @param compilerClassLoader the ClassLoader to use as the basis for org.springframework.org.springframework.expression compilation
	 */
	...
	/**
	 * Return the ClassLoader to use as the basis for org.springframework.org.springframework.expression compilation.
	 */
	@Nullable
