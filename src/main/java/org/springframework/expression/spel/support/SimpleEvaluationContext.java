 ...
 * </ul>
 *
 * <p>Conveniently, {@link org.springframework.expression.spel.support.SimpleEvaluationContext#forReadOnlyDataBinding()}
 * enables read access to properties via {@link DataBindingPropertyAccessor};
 * same for {@link org.springframework.expression.spel.support.SimpleEvaluationContext#forReadWriteDataBinding()} when
 * write access is needed as well. Alternatively, configure custom accessors
 * via {@link org.springframework.expression.spel.support.SimpleEvaluationContext#forPropertyAccessors}, and potentially
...
public final class SimpleEvaluationContext implements EvaluationContext {
	...
	public static class Builder {
		 ...
		 * @see org.springframework.expression.spel.support.SimpleEvaluationContext#forPropertyAccessors
		 */
		 ...
		 * @see org.springframework.expression.spel.support.SimpleEvaluationContext#forReadOnlyDataBinding()
		 * @see org.springframework.expression.spel.support.SimpleEvaluationContext#forReadWriteDataBinding()
		 */
		...
		public org.springframework.expression.spel.support.SimpleEvaluationContext build() {
			return new org.springframework.expression.spel.support.SimpleEvaluationContext(this.accessors, this.resolvers, this.typeConverter, this.rootObject);
		}
	}
