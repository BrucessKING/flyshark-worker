...
/**
 * An ExpressionState is for maintaining per-org.springframework.org.springframework.expression-evaluation state, any changes to
 * it are not seen by other expressions but it gives a place to hold local variables and
 * for component expressions in a compound org.springframework.org.springframework.expression to communicate state. This is in
 * contrast to the EvaluationContext, which is shared amongst org.springframework.org.springframework.expression evaluations, and
