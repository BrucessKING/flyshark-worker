...
public class CodeFlow implements Opcodes {
	 ...
	 * output from the previous org.springframework.org.springframework.expression component). New scopes are used to evaluate
	 ...
	 * the compiled org.springframework.org.springframework.expression method).
	 * @param mv the visitor into which the load instruction should be inserted
	 * @since 4.3.4
	 */
	...
	/**
	 * Record the descriptor for the most recently evaluated org.springframework.org.springframework.expression element.
	...
	/**
	 * Enter a new compilation scope, usually due to nested org.springframework.org.springframework.expression evaluation. For
	 * example when the arguments for a method invocation org.springframework.org.springframework.expression are being evaluated,
	...
	/**
	 * Exit a compilation scope, usually after a nested org.springframework.org.springframework.expression has been evaluated. For
	...
	/**
	 * If the codeflow shows the last org.springframework.org.springframework.expression evaluated to java.lang.Boolean then
	...
	/**
	 * Called after the main org.springframework.org.springframework.expression evaluation method has been generated, this
	 * method will callback any registered FieldAdders or ClinitAdders to add any
	 * extra information to the class representing the compiled org.springframework.org.springframework.expression.
	 */
	public void finish() {
	...
	public static void insertNewArrayCode(MethodVisitor mv, int size, String arraytype) {
		...
		if (arraytype.length() == 1) {
			mv.visitIntInsn(NEWARRAY, arrayCodeFor(arraytype));
		}
		else {
	...
	public interface FieldAdder {
		...
		void generateField(ClassWriter cw, org.springframework.expression.spel.CodeFlow codeflow);
	}
	...
	public interface ClinitAdder {
		...
		void generateCode(MethodVisitor mv, org.springframework.expression.spel.CodeFlow codeflow);
	}
