...
public class PropertyOrFieldReference extends SpelNodeImpl {
	...
	private TypedValue getValueInternal(TypedValue contextObject, EvaluationContext evalContext,
		...
		if (result.getValue() == null && isAutoGrowNullReferences &&
				nextChildIs(Indexer.class, org.springframework.expression.spel.ast.PropertyOrFieldReference.class)) {
	...
	private static class AccessorLValue implements ValueRef {
		...
		public AccessorLValue(org.springframework.expression.spel.ast.PropertyOrFieldReference propertyOrFieldReference, TypedValue activeContextObject,
