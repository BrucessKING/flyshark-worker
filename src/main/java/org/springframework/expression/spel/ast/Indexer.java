...
public class Indexer extends SpelNodeImpl {
	...
	private class PropertyIndexingValueRef implements ValueRef {
		...
		public TypedValue getValue() {
			...
			try {
				if (org.springframework.expression.spel.ast.Indexer.this.cachedReadName != null && org.springframework.expression.spel.ast.Indexer.this.cachedReadName.equals(this.name) &&
						org.springframework.expression.spel.ast.Indexer.this.cachedReadTargetType != null &&
						org.springframework.expression.spel.ast.Indexer.this.cachedReadTargetType.equals(targetObjectRuntimeClass)) {
					// It is OK to use the cached accessor
					PropertyAccessor accessor = org.springframework.expression.spel.ast.Indexer.this.cachedReadAccessor;
					Assert.state(accessor != null, "No cached read accessor");
				...
				for (PropertyAccessor accessor : accessorsToTry) {
					if (accessor.canRead(this.evaluationContext, this.targetObject, this.name)) {
						...
						org.springframework.expression.spel.ast.Indexer.this.cachedReadAccessor = accessor;
						org.springframework.expression.spel.ast.Indexer.this.cachedReadName = this.name;
						org.springframework.expression.spel.ast.Indexer.this.cachedReadTargetType = targetObjectRuntimeClass;
						if (accessor instanceof ReflectivePropertyAccessor.OptimalPropertyAccessor optimalAccessor) {
							...
							org.springframework.expression.spel.ast.Indexer.this.exitTypeDescriptor = CodeFlow.toDescriptor(member instanceof Method method ?
		...
		public void setValue(@Nullable Object newValue) {
			...
			try {
				if (org.springframework.expression.spel.ast.Indexer.this.cachedWriteName != null && org.springframework.expression.spel.ast.Indexer.this.cachedWriteName.equals(this.name) &&
						org.springframework.expression.spel.ast.Indexer.this.cachedWriteTargetType != null &&
						org.springframework.expression.spel.ast.Indexer.this.cachedWriteTargetType.equals(contextObjectClass)) {
					// It is OK to use the cached accessor
					PropertyAccessor accessor = org.springframework.expression.spel.ast.Indexer.this.cachedWriteAccessor;
				...
				for (PropertyAccessor accessor : accessorsToTry) {
					if (accessor.canWrite(this.evaluationContext, this.targetObject, this.name)) {
						org.springframework.expression.spel.ast.Indexer.this.cachedWriteName = this.name;
						org.springframework.expression.spel.ast.Indexer.this.cachedWriteTargetType = contextObjectClass;
						org.springframework.expression.spel.ast.Indexer.this.cachedWriteAccessor = accessor;
						accessor.write(this.evaluationContext, this.targetObject, this.name, newValue);
						return;
					}
				}
