...
public class VariableReference extends SpelNodeImpl {
	...
	public void generateCode(MethodVisitor mv, CodeFlow cf) {
		if (this.name.equals(ROOT)) {
			...
			mv.visitMethodInsn(INVOKEINTERFACE, "org/springframework/org.springframework.org.springframework.expression/EvaluationContext", "lookupVariable", "(Ljava/lang/String;)Ljava/lang/Object;",true);
		}
