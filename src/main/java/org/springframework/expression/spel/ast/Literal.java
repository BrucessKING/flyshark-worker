...
public abstract class Literal extends SpelNodeImpl {
	 ...
	 */
	public static org.springframework.expression.spel.ast.Literal getIntLiteral(String numberToken, int startPos, int endPos, int radix) {
		try {
	...
	public static org.springframework.expression.spel.ast.Literal getLongLiteral(String numberToken, int startPos, int endPos, int radix) {
		try {
	...
	public static org.springframework.expression.spel.ast.Literal getRealLiteral(String numberToken, int startPos, int endPos, boolean isFloat) {
		try {
			if (isFloat) {
