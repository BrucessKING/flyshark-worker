...
public enum SpelMessage {
	...
	ARGLIST_SHOULD_NOT_BE_EVALUATED(Kind.ERROR, 1020,
			"The argument list of a lambda org.springframework.org.springframework.expression should never have getValue() called upon it"),
	...
	MORE_INPUT(Kind.ERROR, 1041,
			"After parsing a valid org.springframework.org.springframework.expression, there is still more data in the org.springframework.org.springframework.expression: ''{0}''"),
	...
	OPERAND_NOT_INCREMENTABLE(Kind.ERROR, 1066,
			"The org.springframework.org.springframework.expression component ''{0}'' does not support increment"),

	OPERAND_NOT_DECREMENTABLE(Kind.ERROR, 1067,
			"The org.springframework.org.springframework.expression component ''{0}'' does not support decrement"),

	NOT_ASSIGNABLE(Kind.ERROR, 1068,
			"The org.springframework.org.springframework.expression component ''{0}'' is not assignable"),
	...
	MISSING_SELECTION_EXPRESSION(Kind.ERROR, 1071,
			"A required selection org.springframework.org.springframework.expression has not been specified"),

	/** @since 4.1 */
	EXCEPTION_RUNNING_COMPILED_EXPRESSION(Kind.ERROR, 1072,
			"An exception occurred whilst evaluating a compiled org.springframework.org.springframework.expression"),
