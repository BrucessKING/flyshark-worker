...
class Token {
	...
	public org.springframework.expression.spel.standard.Token asInstanceOfToken() {
		return new org.springframework.expression.spel.standard.Token(TokenKind.INSTANCEOF, this.startPos, this.endPos);
	}

	public org.springframework.expression.spel.standard.Token asMatchesToken() {
		return new org.springframework.expression.spel.standard.Token(TokenKind.MATCHES, this.startPos, this.endPos);
	}

	public org.springframework.expression.spel.standard.Token asBetweenToken() {
		return new org.springframework.expression.spel.standard.Token(TokenKind.BETWEEN, this.startPos, this.endPos);
	}

	public org.springframework.expression.spel.standard.Token asInToken() {
		return new org.springframework.expression.spel.standard.Token(TokenKind.IN, this.startPos, this.endPos);
	}
