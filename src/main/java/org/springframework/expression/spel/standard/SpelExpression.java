...
/**
 * A {@code SpelExpression} represents a parsed (valid) org.springframework.org.springframework.expression that is ready to be
 * evaluated in a specified context. An org.springframework.org.springframework.expression can be evaluated standalone or in a
 * specified context. During org.springframework.org.springframework.expression evaluation the context may be asked to resolve
...
public class SpelExpression implements Expression {
	...
	// Number of times to interpret an org.springframework.org.springframework.expression before compiling it
	private static final int INTERPRETED_COUNT_THRESHOLD = 100;

	// Number of times to try compiling an org.springframework.org.springframework.expression before giving up
	...
	// Holds the compiled form of the org.springframework.org.springframework.expression (if it has been compiled)
	@Nullable
	private volatile CompiledExpression compiledAst;

	// Count of many times as the org.springframework.org.springframework.expression been interpreted - can trigger compilation
	...
	/**
	 * Construct an org.springframework.org.springframework.expression, only used by the parser.
	 */
	...
	/**
	 * Compile the org.springframework.org.springframework.expression if it has been evaluated more than the threshold number
	 * of times to trigger compilation.
	 * @param expressionState the org.springframework.org.springframework.expression state used to determine compilation mode
	 */
	...
	/**
	 * Perform org.springframework.org.springframework.expression compilation. This will only succeed once exit descriptors for
	 * all nodes have been determined. If the compilation fails and has failed more than
	 * 100 times the org.springframework.org.springframework.expression is no longer considered suitable for compilation.
	 * @return whether this org.springframework.org.springframework.expression has been successfully compiled
	 */
	...
	/**
	 * Cause an org.springframework.org.springframework.expression to revert to being interpreted if it has been using a compiled
	 * form. It also resets the compilation attempt failure count (an org.springframework.org.springframework.expression is normally no
	...
	/**
	 * Return the Abstract Syntax Tree for the org.springframework.org.springframework.expression.
	 */
	...
	/**
	 * Produce a string representation of the Abstract Syntax Tree for the org.springframework.org.springframework.expression.
	 * This should ideally look like the input org.springframework.org.springframework.expression, but properly formatted since any
	 * unnecessary whitespace will have been discarded during the parse of the org.springframework.org.springframework.expression.
