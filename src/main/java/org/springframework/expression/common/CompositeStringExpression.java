...
/**
 * Represents a template org.springframework.org.springframework.expression broken into pieces. Each piece will be an Expression
 * but pure text parts to the template will be represented as LiteralExpression objects.
 * An example of a template org.springframework.org.springframework.expression might be:
 *
 * <pre class="code">
 * &quot;Hello ${getName()}&quot;
 * </pre>
 ...
 * org.springframework.org.springframework.expression that will call {@code getName()} when invoked.
 *
 * @author Andy Clement
...
public class CompositeStringExpression implements Expression {
	...
	/** The array of expressions that make up the composite org.springframework.org.springframework.expression. */
	...
	public void setValue(@Nullable Object rootObject, @Nullable Object value) throws EvaluationException {
		throw new EvaluationException(this.expressionString, "Cannot call setValue on a composite org.springframework.org.springframework.expression");
	}
