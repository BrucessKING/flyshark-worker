...
/**
 * An org.springframework.org.springframework.expression capable of evaluating itself against context objects.
 * Encapsulates the details of a previously parsed org.springframework.org.springframework.expression string.
 * Provides a common abstraction for org.springframework.org.springframework.expression evaluation.
 *
 * @author Keith Donald
 * @author Andy Clement
...
public interface Expression {
	...
	/**
	 * Return the original string used to create this org.springframework.org.springframework.expression (unmodified).
	 * @return the original org.springframework.org.springframework.expression string
	 */
	String getExpressionString();

	/**
	 * Evaluate this org.springframework.org.springframework.expression in the default standard context.
	...
	/**
	 * Evaluate the org.springframework.org.springframework.expression in the default context. If the result
	...
	/**
	 * Evaluate this org.springframework.org.springframework.expression against the specified root object.
	 * @param rootObject the root object against which to evaluate the org.springframework.org.springframework.expression
	 * @return the evaluation result
	 * @throws EvaluationException if there is a problem during evaluation
	 */
	@Nullable
	...
	/**
	 * Evaluate the org.springframework.org.springframework.expression in the default context against the specified root
	...
	/**
	 * Evaluate this org.springframework.org.springframework.expression in the provided context and return the result
	 * of evaluation.
	 * @param context the context in which to evaluate the org.springframework.org.springframework.expression
	 * @return the evaluation result
	 * @throws EvaluationException if there is a problem during evaluation
	 */
	@Nullable
	...
	/**
	 * Evaluate the org.springframework.org.springframework.expression in a specified context which can resolve references
	...
	/**
	 * Determine if an org.springframework.org.springframework.expression can be written to, i.e. setValue() can be called.
	 * @param rootObject the root object against which to evaluate the org.springframework.org.springframework.expression
	 * @return {@code true} if the org.springframework.org.springframework.expression is writable; {@code false} otherwise
	...
	/**
	 * Determine if an org.springframework.org.springframework.expression can be written to, i.e. setValue() can be called.
	 * @param context the context in which the org.springframework.org.springframework.expression should be checked
	 * @return {@code true} if the org.springframework.org.springframework.expression is writable; {@code false} otherwise
	 * @throws EvaluationException if there is a problem determining if it is writable
	 */
	...
	/**
	 * Set this org.springframework.org.springframework.expression in the provided context to the value provided.
	 * @param rootObject the root object against which to evaluate the org.springframework.org.springframework.expression
	...
	/**
	 * Set this org.springframework.org.springframework.expression in the provided context to the value provided.
	 * @param context the context in which to set the value of the org.springframework.org.springframework.expression
	 * @param value the new value
	 * @throws EvaluationException if there is a problem during evaluation
	 */
